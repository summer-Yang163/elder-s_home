  ...
  <Modal
    ...
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
      <Form-item label="服务订单编号" prop="serviceOrderId">
        <Input disabled v-model="formValidate.serviceOrderId" placeholder="请输入服务订单编号"></Input>
      </Form-item>
      <Form-item label="服务项目名称" prop="projectName">
        <Input disabled v-model="formValidate.projectName" placeholder="请输入服务项目名称"></Input>
      </Form-item>
      <Form-item label="服务老人" prop="oldName">
        <Input disabled v-model="formValidate.oldName" placeholder="请关联服务老人"></Input>
      </Form-item>
      <Form-item label="服务工作人员" prop="serviceName">
        <Input disabled v-model="formValidate.serviceName" placeholder="请关联服务工作人员"></Input>
      </Form-item>
      <Form-item label="下单用户" prop="userName">
        <Input disabled v-model="formValidate.userName" placeholder="请输入下单用户"></Input>
      </Form-item>
      <Form-item label="服务次数" prop="serviceNum">
        <Input disabled v-model="formValidate.serviceNum" placeholder="请输入服务次数"></Input>
      </Form-item>
      <Form-item label="服务实际价格" prop="servicePrice">
        <Input disabled v-model="formValidate.servicePrice" placeholder="请输入服务实际价格"></Input>
      </Form-item>
      <Form-item label="服务开始时间" prop="beginTime">
        <Input disabled v-model="formValidate.beginTime" placeholder="请填写服务开始时间"></Input>
      </Form-item>
      <Form-item label="服务结束时间" prop="endTime">
        <Input disabled v-model="formValidate.endTime" placeholder="请填写服务结束时间"></Input>
      </Form-item>
      <Form-item label="服务地点" prop="serviceAddress">
        <Input disabled v-model="formValidate.serviceAddress" placeholder="请输入服务地点"></Input>
      </Form-item>
      <Form-item label="用户评价单号" prop="evaluationId">
        <Input disabled v-model="formValidate.evaluationId" placeholder="请输入服务评价单号"></Input>
      </Form-item>
      <Form-item label="支付状态" prop="payStatus">
        <Input disabled v-model="formValidate.payStatus" placeholder="请填写订单支付状态"></Input>
      </Form-item>
      <Form-item label="订单状态" prop="orderStatus">
        <Input disabled v-model="formValidate.orderStatus" placeholder="请填写订单状态"></Input>
      </Form-item>
      <Form-item label="备注" prop="remarks">
        <Input disabled v-model="formValidate.remarks" placeholder="填写服务订单备注信息"></Input>
      </Form-item>
    </Form>
  </Modal>
</template>
<script>
  export default {
    props:[ 'fyType','conData'],
    data(){
      return {
//          title:this.$props.conData ? '修改用户管理' : '新增用户管理',
        modal1:true,
        myModal:this.fyType,//首先建立一个props的副本
